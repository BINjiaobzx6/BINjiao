local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/BINjiaobzx6/BINjiao/main/ui.txt')))()
local Window = OrionLib:MakeWindow({IntroText = "XK脚本中心V5.0",Name = "XK脚本中心", HidePremium = false, SaveConfig = true, ConfigFolder = ""})
